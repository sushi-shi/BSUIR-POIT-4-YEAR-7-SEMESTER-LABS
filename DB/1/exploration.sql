...
--
-- Host: localhost    Database: db_labs_exploration
-- ------------------------------------------------------
...
CREATE TABLE `connections` (
  ...
  `cn_bidir` enum('N','Y') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `library_in_json` (
  ...
  `lij_book` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lij_author` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`lij_author`)),
  `lij_genre` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`lij_genre`)),
  PRIMARY KEY (`lij_id`)
...
CREATE TABLE `shopping` (
  ...
  `sh_category` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`sh_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `site_pages` (
  ...
  `sp_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`sp_id`),
  KEY `FK_site_pages_site_pages` (`sp_parent`),
  CONSTRAINT `FK_site_pages_site_pages` FOREIGN KEY (`sp_parent`) REFERENCES `site_pages` (`sp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-11-07  0:30:05
