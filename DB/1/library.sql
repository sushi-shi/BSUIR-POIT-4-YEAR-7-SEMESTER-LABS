...
--
-- Host: localhost    Database: db_labs_library
-- ------------------------------------------------------
...
CREATE TABLE `authors` (
  ...
  `a_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`a_id`)
...
CREATE TABLE `genres` (
  ...
  `g_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`g_id`),
...
INSERT INTO `m2m_books_authors` VALUES (1,7),(2,7),(3,2),(4,3),(4,6),(5,6),(6,4),(6,5),(7,1);
...
CREATE TABLE `m2m_books_genres` (
  ...
  CONSTRAINT `FK_m2m_books_genres_books` FOREIGN KEY (`b_id`) REFERENCES `books` (`b_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_m2m_books_genres_genres` FOREIGN KEY (`g_id`) REFERENCES `genres` (`g_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m2m_books_genres` VALUES (1,1),(1,5),(2,1),(2,5),(3,6),(4,2),(4,3),(5,2),(6,5),(7,2),(7,5);
...
CREATE TABLE `subscriptions` (
  ...
  `sb_is_active` enum('Y','N') COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`sb_id`),
...
-- Dump completed on 2021-11-07  0:30:22
